package uk.co.danielturner.portfolio.components.sections
...
import uk.co.danielturner.portfolio.components.widgets.IconButton
...
fun NavHeader() {
    Row(NavHeaderStyle.toModifier(), verticalAlignment = Alignment.CenterVertically) {
        ...
        Row(Modifier.gap(1.5.cssRem).displayIfAtLeast(Breakpoint.SM), verticalAlignment = Alignment.CenterVertically) {
            ColorModeButton()
            MenuItems()
        }
